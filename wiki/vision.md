...
- `wiki/vault/lessons/` — Per-feature lessons learned
- `wiki/vault/context/` — Decisions, patterns, project principles
- `wiki/vault/graph/` — Code structure index (generated by code analysis tool)
