...
## [GitHub - lucasastorian/llmwiki: Open Source Implementation of Karpathy's LLM Wiki. Upload…](https://github.com/lucasastorian/llmwiki?source=post_page-----7824d876e790---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*LsdJU8rkgCvXbU6KtLV-fQ.png)
...
![](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*3Cl-8UEFXy6DCJYM46UNEA.png)
...
Btw If you liked this article then you would definitely like my latest work (04/13/2026)
