...
**Artifact Files:**
- Specs: `specs/NNNN-feature-name.md` (project root; kebab-case; numeric prefix for ordering; generated by `/speckit.specify`)
- Plans: `specs/NNNN-feature-name-plan.md` (same directory as spec; generated by `/speckit.plan`)
- Lessons: `vault/lessons/YYYY-MM-DD-feature-name.md` (archived after `/spek.conclude`)
