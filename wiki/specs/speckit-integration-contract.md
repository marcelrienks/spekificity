...
### Layer 3: Post-Processing Layer (`/spek.post`)
...
| **Orchestration** | — | ✓ Optional | `/spek.automate` command |
...
4. Proceed to `/spek.post` anyway (lessons even from partial work)
...
8. ✅ `/spek.automate` orchestrates entire flow sequentially
