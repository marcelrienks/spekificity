...
**Original ID:** C.3.6  
**See:** [Validation Patterns Archive](142-validation-patterns-archive.md#section-2-backprop-reflex-test-failures--vault-updates)
...
- Auto-tag + auto-link (existing C.3.2)
...
- Generate lesson markdown (existing)
