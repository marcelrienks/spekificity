...
**Spekificity adaptation:**
```
In /spek.specify: Flag specs that contradict recent decisions
In /spek.plan: Flag plans that ignore code graph insights
...
**Spekificity approach:** All phases optional. Can run `/spek.clarify` or skip. Can re-run `/spek.plan` anytime.
