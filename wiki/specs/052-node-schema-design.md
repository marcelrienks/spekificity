...
- ## References
- **Related Specs:**
- [spek-map-command.md](103-spek-map-command.md) — Graph generation command
- [graph-storage-structure.md](051-graph-storage-structure.md) — Storage format (nodes.jsonl)
- [obsidian-graph-export.md](061-obsidian-graph-export.md) — Doc node extraction
- [graph-query-patterns.md](054-graph-query-patterns.md) — Node querying strategies
- }
- ```
...
> Example moved to [Example: 052-node-schema-design-code-1.md](./examples/052-node-schema-design-code-1.md)
