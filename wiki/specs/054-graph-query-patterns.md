...
- ## References
- **Related Specs:**
- [graph-storage-structure.md](051-graph-storage-structure.md) — nodes.jsonl, edges.jsonl schemas
- [context-layer.md](031-context-layer.md) — Context queries code graph
- [enrichment-layer.md](032-enrichment-layer.md) — Enrichment uses code graph queries
- **External:**
