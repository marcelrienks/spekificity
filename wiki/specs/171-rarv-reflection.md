...
**Original ID:** C.3.7  
**See:** [Validation Patterns Archive](142-validation-patterns-archive.md#section-3-rarv-reflection-cycle-reason-act-reflect-verify)
...
- **Process:**
- ```
- Get original spec (spec.md)
- Get final plan (plan.md)
- Get implemented code (diff from branch)
- Compare:
...
- Action:
- Update plan.md: "Use factory pattern instead of singleton"
- Update decisions: "Why factory: testability > simplicity in this case"
- Continue to Phase 3
- ### Phase 3: REFLECT - Update Decisions
- **When:** After deviations resolved (or accepted)
- Compare final implementation against decisions in vault
- For each decision that changed:
...
- Add reflection notes to feature lesson
- reflect_results:
...
- Re-run original decision checks
...
- /spek.conclude Step 7: RARV starts
- REASON phase: "Alignment: 98%; 1 minor deviation found"
- ACT phase: User accepts deviation (added logging for debugging)
- REFLECT phase: Vault updated (no decision changes)
- VERIFY phase: "✓ Alignment: 99%; ready for production"
- Continue to Step 8
- ### Spec Drift Caught & Fixed
- REASON phase: "Alignment: 72%; 4 major deviations found"
...
- VERIFY phase: "✓ Alignment: 94%; all decisions consistent"
